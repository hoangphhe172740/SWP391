...
/**
 * Servlet implementation class DeleteMentorControl
 */
@WebServlet(name="DeleteMentorControl", urlPatterns={"/deletementor"})
public class DeleteMentorControl extends HttpServlet {
    ...
    public String getServletInfo() {
        return "Servlet for deleting mentors";
    }
