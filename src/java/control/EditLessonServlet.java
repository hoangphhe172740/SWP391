...
public class EditLessonServlet extends HttpServlet {
    ...
    private dao.DAO lessonDAO = new DAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (a != null) {
            ...
            Lesson lesson = new Lesson(moduleId, lessonId, lessonName, lessonVideo, duration, a.getId());

            // Update the lesson in the database
            lessonDAO.updateLesson(lesson);

            // Redirect to the lesson detail page or any other page
