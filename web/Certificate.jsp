                ...
                <div class="table-title">
                    <div class="d-flex justify-content-between">
                        <div class="col-sm-6 pt-3">
                            <a href="home" style="text-decoration: none; color: #fff;"><h2><b>Certificate</b></h2></a>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="join-now-btn col">
                                            <b><a href="CertificateGeneratorServlet?courseName=${o.courseName}" style=" text-decoration: none; color: #fff;">View Certificate</a></b>
                                        </button>
                                    </td>
                                </tr>
                            </c:forEach>
