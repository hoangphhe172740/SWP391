                    ...
                    <div class="table-title">
                        <div class="d-flex justify-content-between">
                            <div class="col-sm-6 pt-3">
                                <a href="home" style="text-decoration: none;color: #fff;"><h2>Manage <b>Mentor</b></h2></a>
                            </div>
                        ...
                        <tbody>
                            <c:forEach items="${listMentor}" var="o">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="load-mentor?mentorID=${o.mentorId}" class="edit btn btn-info mb-3"><i class="material-symbols-outlined" title="Edit">&#xE254;</i></a>
                                    ...
                                    <td>
                                        <a href="load-account?MentorID=${o.mentorId}" title="Create Accout"><i class="material-icons">&#xE147;</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:if>
